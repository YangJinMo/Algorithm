...
/**
 ...
 - 원문: https://www.acmicpc.net/problem/1110
 */
...
class Problem_1110 {
  ...
  func solution_2() {
    var n=Int(readLine()!)!,m=n,i=0;while true{n=n%10*10+(n/10+n%10)%10;i+=1;if m==n{break}};print(i)
  }
  func solution_3() {
    var n=Int(readLine()!)!,m=n,i=0;repeat{let b=n%10;n=b*10+(n/10+b)%10;i+=1}while m != n;print(i)
  }
  /// https://www.acmicpc.net/short/status/1110/74/1
  /// 1등
  func solution_zzimss() {
    var n=Int(readLine()!)!,m=n,i=0;repeat{n=n%10*10+(n/10+n%10)%10;i+=1}while m != n;print(i)
  }
}
